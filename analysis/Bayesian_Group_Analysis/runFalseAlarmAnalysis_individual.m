...
%% Run JAGS
savefn = sprintf('samples_falseAlarms_s%d.mat', si);
...
post_d11 = datasample([squeeze(samples.thetaf(1,:,1,:))], 500);
post_d12 = datasample([squeeze(samples.thetaf(1,:,2,:))], 500);
post_d13 = datasample([squeeze(samples.thetaf(1,:,3,:))], 500);

post_d21 = datasample([squeeze(samples.thetaf(1,:,4,:))], 500);
post_d22 = datasample([squeeze(samples.thetaf(1,:,5,:))], 500);
post_d23 = datasample([squeeze(samples.thetaf(1,:,6,:))], 500);
