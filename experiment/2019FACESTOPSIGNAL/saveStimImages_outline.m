function saveStimImages_outline(condition, imageName)
...
if ismember(condition, [3 4])
    basebot = {'faceoutline1.bmp', 'faceoutline1.bmp', 'faceoutline1.bmp'};
    basetop = {'faceoutline1.bmp', 'faceoutline1.bmp', 'faceoutline1.bmp'};
